...
class NewsController extends BackController
{
  public function executeDelete(HTTPRequest $request)
  {
    ...
    // Suppression des caches correspondant lors de la suppression d'une news
    $cache = new Cache($this->managers->getManagerOf('News')->getUnique($newsId));
  ...
  public function executeUpdateComment(HTTPRequest $request)
  {
    ...
    if ($request->method() == 'POST')
    {
      $comment = new Comment([
        ...
        'news' => $this->managers->getManagerOf('Comments')->get($request->getData('id'))->news(),
    ...
    {
      // Suppression des caches correspondant lors de la modification
      $cache = new Cache($comment);
      $cache->unlinkDataAndShowCaches();
